            ...
            <Card className="w-full">
                ...
                <form onSubmit={handleSubmit}>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <button
                                    ...
                                    className={`absolute ${isRTL ? 'left-3' : 'right-3'} top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-md p-1`}
                    ...
                    <CardFooter className="flex flex-col gap-4 px-4 sm:px-6 pt-4 sm:pt-6">
                        ...
                        <div className="text-xs text-muted-foreground text-center mt-2 space-x-2">
