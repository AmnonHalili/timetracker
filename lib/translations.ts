...
export const translations = {
  en: {
    ...
    'notifications.newJoinRequest': 'New Join Request',
    'notifications.joinRequestMessage': '{name} has requested to join your project.',
    ...
    'settings.pushNotificationsDescription': 'Receive notifications about tasks, messages, and updates directly to your device.',
    'settings.deviceNotifications': 'Device Notifications',
    'settings.deviceSubscribed': 'This device is currently subscribed to notifications.',
    'settings.enablePushNotifications': 'Enable push notifications for this device.',
    'settings.enabled': 'Enabled',
    'settings.enable': 'Enable',
    'settings.workLocation': 'Work Location',
    'settings.workLocationDescription': 'Configure work location settings. Choose between remote work (no location verification) or location-based work (GPS verification required).',
    'settings.workLocationSaved': 'Work location saved successfully',
    'settings.workLocationRemoved': 'Work location removed',
    'settings.workLocationSaveError': 'Failed to save work location',
    'settings.workLocationUpdateError': 'Failed to update work location settings',
    'settings.workLocationSettingsUpdateError': 'Failed to update settings',
    ...
    'preferences.weeklyHoursDescription': 'Set the number of work hours for each day of the week. Leave empty or set to 0 for days you don\'t work.',
    'preferences.hours': 'hours',
    'preferences.sunThu': 'Sun-Thu',
    'preferences.monFri': 'Mon-Fri',
    ...
    'tasks.deleteMessageConfirm': 'Are you sure you want to delete this message? This action cannot be undone.',
    'tasks.deleteFileConfirm': 'Are you sure you want to delete this file? This action cannot be undone.',
    'tasks.messageDeleted': 'Message deleted',
    'tasks.fileDeleted': 'File deleted',
    'tasks.messageDeleteError': 'Failed to delete message',
    'tasks.fileDeleteError': 'Failed to delete file',
    'tasks.updateError': 'Failed to update task status',
    'tasks.addSubtaskError': 'Failed to add subtask',
    'tasks.deleteError': 'Failed to delete task. Please try again.',
    'tasks.startWorking': 'Start Working',
    'tasks.stopWorking': 'Stop Working',
    'tasks.undo': 'Undo',
    ...
    'tasks.generalInfo': 'General Information',
    'tasks.schedule': 'Schedule',
    'tasks.searchTeam': 'Search team members...',
    'tasks.selected': 'Selected',
    'tasks.showToMeHint': 'Automatically add yourself as an assignee.',
    'tasks.addTask': 'Add Task',
    'tasks.assignedTo': 'Assigned',
    'tasks.priorityShort': 'Pri',
    'tasks.manageTeamTasks': 'Manage team tasks',
    'tasks.allTasksCount': 'All Tasks ({count})',
    'tasks.totalCount': '{count} Total',
    'tasks.sort': 'Sort',
    'tasks.filters': 'Filters',
    'tasks.thisWeek': 'This Week',
    'tasks.allTasks': 'All Tasks',
    'tasks.mentionUser': 'Mention User',
    'tasks.mentionSomeone': 'Mention someone (@)',
    ...
    'tasks.statusOverdue': 'Overdue',
    'tasks.statusBlocked': 'Blocked',
    'tasks.addSubtaskPlaceholder': 'Add subtask...',
    'tasks.sortByDeadlineNear': 'By deadline: Closest → Farthest',
    'tasks.sortByDeadlineFar': 'By deadline: Farthest → Closest',
    'tasks.sortByPriorityHigh': 'By priority: High → Low',
    'tasks.sortByPriorityLow': 'By priority: Low → High',
    'tasks.sortByCreatedNew': 'By time: Newest → Oldest',
    'tasks.sortByCreatedOld': 'By time: Oldest → Newest',
    'tasks.assignedToMe': 'Assigned to me',
    'tasks.tasksICreated': 'Tasks I created',
    'tasks.editSubtask': 'Edit Subtask',
    'tasks.deleteSubtask': 'Delete Subtask',
    'tasks.showSubtasks': 'Show {count} subtasks',
    'tasks.hideSubtasks': 'Hide {count} subtasks',
    'tasks.subtasksDone': '{done}/{total} done',
    'tasks.usersWorking': '{count} users on it',
    'tasks.userIsWorking': '{name} is on it',
    'tasks.youAreOnIt': 'You are on it',
    'tasks.personalScope': 'Personal Scope',
    'tasks.editSubtaskDetails': 'Edit Subtask Details',
    'tasks.subtaskPriority': 'Priority',
    'tasks.subtaskAssignee': 'Assignee',
    'tasks.subtaskAssignedTo': 'Assigned To',
    'tasks.subtaskDueDate': 'Due Date',
    'tasks.pickDate': 'Pick a date',
    'tasks.unassigned': 'Unassigned',
    'tasks.showMoreSubtasks': 'Show {count} more subtasks',
    'tasks.subtaskDueToday': 'Due Today',
    'tasks.subtaskOverdue': 'Overdue by {days}d',
    'tasks.subtaskDueSoon': 'Due in {days}d',
    ...
    'tasks.noSubtasksYet': 'No subtasks yet',
    'tasks.details': 'Details',
    'tasks.notes': 'Notes',
    'tasks.files': 'Files',
    'tasks.subtaskNoPriority': 'No Priority',
    'tasks.subtaskNoAssignee': 'Unassigned',
    'tasks.subtasks': 'Subtasks',
    'tasks.subtaskTitlePlaceholder': 'Subtask title',
    'tasks.titlePlaceholder': 'Task title',
    'tasks.dueDate': 'Due Date',
    'tasks.workLog': 'Work Log',
    'tasks.completion': 'Completion Progress',
    ...
    // Project Switcher
    'projects.leaveWorkspace': 'Leave Workspace',
    'projects.leaveConfirmTitle': 'Are you sure?',
    'projects.leaveConfirmDescription': 'You will lose access to all tasks and data in this workspace. This action cannot be undone.',
    'projects.leaveAdminWarning': 'You are the last admin. You must promote another member to admin or delete the workspace.',
    'projects.selectWorkspace': 'Select Workspace',
    'projects.searchTeam': 'Search team...',
    'projects.noTeamFound': 'No team found.',
    'projects.teams': 'Teams',
    'projects.invited': 'Invited',
    'projects.createTeam': 'Create Team',
    'projects.joinTeam': 'Join Team',
    'projects.teamName': 'Team Name',
    'projects.inviteCode': 'Invite Code',
    'projects.enterCode': 'Enter code',
    'projects.creating': 'Creating...',
    'projects.sendingRequest': 'Sending Request...',
    'projects.teamInvitation': 'Team Invitation',
    'projects.invitedToJoin': 'You have been invited to join',
    'projects.decline': 'Decline',
    'projects.accepting': 'Accepting...',
    'projects.acceptInvitation': 'Accept Invitation',
    'projects.addNewWorkspace': 'Add a new workspace to manage projects and tasks.',
    'projects.enterInviteCode': 'Enter the invite code shared by your team administrator.',
    'projects.free': 'Free',
    ...
    'timeEntries.deleteConfirm': 'Are you sure you want to delete this time entry? This action cannot be undone.',
    ...
    'team.reportsTo': 'Reports To',
    'team.selectManagerRequired': 'Select Manager (Required)',
    'team.teamMemberMustReport': 'Team members must report to a manager.',
    'team.addNewChief': 'Add New Chief',
    'team.addTeamMember': 'Add Member',
    ...
    'team.createEmployeeAccount': 'Create a new account for your member. They will be added to your project immediately.',
    'team.chiefType': 'Chief Type',
    'team.chiefTypeDescription': 'Select how this chief should be added to the organization',
    'team.partnerSharedLeadership': 'Partner – Shared Leadership',
    'team.partnerDescription': 'Acts as a shared manager with you. Both manage the same team.',
    'team.independentChief': 'Independent Chief',
    'team.independentDescription': 'Separate top-level manager with their own hierarchy.',
    'team.sendInvitation': 'Send Invitation',
    'team.emailLabel': 'Email',
    'team.jobTitleLabel': 'Job Title',
    'team.teamMemberSettings': 'Member Settings',
    ...
    'landing.description': 'The all-in-one workspace for every team. Seamlessly track hours, manage complex projects, and lead your organization with clarity. A professional solution tailored for freelancers, startups, and established enterprises.',
  ...
  he: {
    ...
    'notifications.newJoinRequest': 'בקשת הצטרפות חדשה',
    'notifications.joinRequestMessage': '{name} ביקש להצטרף לפרויקט שלך.',
    ...
    'dashboard.startDay': 'התחל יום',
    'dashboard.endDay': 'סיים יום',
    ...
    'settings.pushNotificationsDescription': 'קבל התראות על משימות, הודעות ועדכונים ישירות למכשיר שלך.',
    'settings.deviceNotifications': 'התראות מכשיר',
    'settings.deviceSubscribed': 'מכשיר זה מנוי כעת להתראות.',
    'settings.enablePushNotifications': 'הפעל התראות push למכשיר זה.',
    'settings.enabled': 'מופעל',
    'settings.enable': 'הפעל',
    'settings.workLocation': 'מיקום עבודה',
    'settings.workLocationDescription': 'הגדר הגדרות מיקום עבודה. בחר בין עבודה מרחוק (ללא אימות מיקום) או עבודה מבוססת מיקום (נדרש אימות GPS).',
    'settings.workLocationSaved': 'מיקום עבודה נשמר בהצלחה',
    'settings.workLocationRemoved': 'מיקום עבודה הוסר',
    'settings.workLocationSaveError': 'שגיאה בשמירת מיקום עבודה',
    'settings.workLocationUpdateError': 'שגיאה בעדכון הגדרות מיקום עבודה',
    'settings.workLocationSettingsUpdateError': 'שגיאה בעדכון ההגדרות',
    ...
    'preferences.weeklyHoursDescription': 'הגדר את מספר שעות העבודה לכל יום בשבוע. השאר ריק או הגדר ל-0 לימים שאתה לא עובד.',
    'preferences.hours': 'שעות',
    'preferences.sunThu': 'א׳-ה׳',
    'preferences.monFri': 'ב׳-ו׳',
    'preferences.clear': 'נקה',
    ...
    'tasks.deleteConfirm': 'האם אתה בטוח שברצונך למחוק את המשימה הזו? פעולה זו לא ניתנת לביטול.',
    'tasks.deleteMessageConfirm': 'האם אתה בטוח שברצונך למחוק את ההודעה הזו? פעולה זו לא ניתנת לביטול.',
    'tasks.deleteFileConfirm': 'האם אתה בטוח שברצונך למחוק את הקובץ הזה? פעולה זו לא ניתנת לביטול.',
    'tasks.messageDeleted': 'הודעה נמחקה',
    'tasks.fileDeleted': 'קובץ נמחק',
    'tasks.messageDeleteError': 'שגיאה במחיקת ההודעה',
    'tasks.fileDeleteError': 'שגיאה במחיקת הקובץ',
    'tasks.updateError': 'שגיאה בעדכון סטטוס המשימה',
    'tasks.addSubtaskError': 'שגיאה בהוספת תת משימה',
    'tasks.deleteError': 'שגיאה במחיקת המשימה. אנא נסה שוב.',
    'tasks.startWorking': 'התחל עבודה',
    'tasks.stopWorking': 'הפסק עבודה',
    'tasks.undo': 'בטל',
    ...
    'tasks.generalInfo': 'מידע כללי',
    'tasks.schedule': 'לוח זמנים',
    'tasks.searchTeam': 'חיפוש חברי צוות...',
    'tasks.selected': 'נבחרו',
    'tasks.showToMeHint': 'הוסף את עצמך אוטומטית כמבצע המשימה.',
    'tasks.addTask': 'הוסף משימה',
    'tasks.assignedTo': 'הקצאה',
    'tasks.priorityShort': 'עדיפות',
    'tasks.manageTeamTasks': 'נהל משימות צוות',
    'tasks.allTasksCount': 'כל המשימות ({count})',
    'tasks.totalCount': 'סה"כ {count}',
    'tasks.sort': 'מיון',
    'tasks.filters': 'מסננים',
    'tasks.thisWeek': 'השבוע',
    'tasks.allTasks': 'כל המשימות',
    'tasks.mentionUser': 'תיוג משתמש',
    'tasks.mentionSomeone': 'תייג מישהו (@)',
    ...
    'tasks.priorityNone': 'ללא',
    'tasks.priorityLow': 'נמוך',
    'tasks.priorityMedium': 'בינוני',
    'tasks.priorityHigh': 'גבוה',
    'tasks.statusTodo': 'פתוח',
    'tasks.statusInProgress': 'בביצוע',
    'tasks.statusDone': 'הושלם',
    'tasks.statusOverdue': 'איחור',
    'tasks.statusBlocked': 'חסום',
    'tasks.addSubtaskPlaceholder': 'הוסף תת משימה...',
    'tasks.sortByDeadlineNear': 'לפי תאריך: מהקרוב לרחוק',
    'tasks.sortByDeadlineFar': 'לפי תאריך: מהרחוק לקרוב',
    'tasks.sortByPriorityHigh': 'לפי עדיפות: מגבוה לנמוך',
    'tasks.sortByPriorityLow': 'לפי עדיפות: מנמוך לגבוה',
    'tasks.sortByCreatedNew': 'לפי זמן: מהחדש לישן',
    'tasks.sortByCreatedOld': 'לפי זמן: מהישן לחדש',
    'tasks.assignedToMe': 'הוקצה לי',
    'tasks.tasksICreated': 'משימות שיצרתי',
    'tasks.editSubtask': 'ערוך תת משימה',
    'tasks.deleteSubtask': 'מחק תת משימה',
    'tasks.showSubtasks': 'הצג {count} תת משימות',
    'tasks.hideSubtasks': 'הסתר {count} תת משימות',
    'tasks.subtasksDone': '{done}/{total} הושלמו',
    'tasks.usersWorking': 'עובדים על זה {count} משתמשים',
    'tasks.userIsWorking': '{name} עובד על זה',
    'tasks.youAreOnIt': 'אתה עובד על זה',
    'tasks.personalScope': 'היקף אישי',
    'tasks.editSubtaskDetails': 'ערוך פרטי תת-משימה',
    'tasks.subtaskPriority': 'עדיפות',
    'tasks.subtaskAssignee': 'אחראי',
    'tasks.subtaskAssignedTo': 'משויך ל',
    'tasks.subtaskDueDate': 'תאריך יעד',
    'tasks.pickDate': 'בחר תאריך',
    'tasks.unassigned': 'לא שויך',
    'tasks.showMoreSubtasks': 'הצג עוד {count} תתי-משימות',
    'tasks.subtaskDueToday': 'היום',
    'tasks.subtaskOverdue': 'איחור של {days} ימים',
    'tasks.subtaskDueSoon': 'בעוד {days} ימים',
    ...
    'tasks.noSubtasksYet': 'אין תתי-משימות עדיין',
    'tasks.details': 'פרטים',
    'tasks.notes': 'הערות',
    'tasks.files': 'קבצים',
    'tasks.subtaskNoPriority': 'ללא עדיפות',
    'tasks.subtaskNoAssignee': 'לא משוייך',
    ...
    'tasks.workLog': 'יומן עבודה',
    'tasks.completion': 'התקדמות ביצוע',
    ...
    // Project Switcher
    'projects.leaveWorkspace': 'יציאה מהפרויקט',
    'projects.leaveConfirmTitle': 'האם אתה בטוח?',
    'projects.leaveConfirmDescription': 'תאבד את הגישה לכל המשימות והנתונים במרחב עבודה זה. פעולה זו לא ניתנת לביטול.',
    'projects.leaveAdminWarning': 'אתה המנהל האחרון. עליך למנות חבר אחר למנהל או למחוק את מרחב העבודה.',
    'projects.selectWorkspace': 'בחר סביבת עבודה',
    'projects.searchTeam': 'חפש צוות...',
    'projects.noTeamFound': 'לא נמצא צוות.',
    'projects.teams': 'צוותים',
    'projects.invited': 'הוזמן',
    'projects.createTeam': 'צור צוות',
    'projects.joinTeam': 'הצטרף לצוות',
    'projects.teamName': 'שם הצוות',
    'projects.inviteCode': 'קוד הזמנה',
    'projects.enterCode': 'הזן קוד',
    'projects.creating': 'יוצר...',
    'projects.sendingRequest': 'שולח בקשה...',
    'projects.teamInvitation': 'הזמנת צוות',
    'projects.invitedToJoin': 'הוזמנת להצטרף ל',
    'projects.decline': 'דחה',
    'projects.accepting': 'מאשר...',
    'projects.acceptInvitation': 'אשר הזמנה',
    'projects.addNewWorkspace': 'הוסף סביבת עבודה חדשה לניהול פרויקטים ומשימות.',
    'projects.enterInviteCode': 'הזן את קוד ההזמנה ששותף על ידי מנהל הצוות שלך.',
    'projects.free': 'חינם',
    ...
    'timeEntries.deleteConfirm': 'האם אתה בטוח שברצונך למחוק את רשומת הזמן הזו? פעולה זו לא ניתנת לביטול.',
    ...
    'reports.netHours': 'שעות נטו',
    'reports.sessions': 'סשנים',
    ...
    'team.reportsTo': 'דיווח ל',
    'team.selectManagerRequired': 'בחר מנהל (חובה)',
    'team.teamMemberMustReport': 'חברי צוות חייבים לדווח למנהל.',
    'team.addNewChief': 'הוסף מנהל ראשי חדש',
    'team.addTeamMember': 'הוסף חבר',
    'team.createChiefAccount': 'צור חשבון חדש למנהל ראשי. תוכל להקצות אותו כשותף או כמנהל עצמאי.',
    'team.createEmployeeAccount': 'צור חשבון חדש לחבר שלך. הוא יתווסף לפרויקט שלך מיד.',
    'team.chiefType': 'סוג מנהל',
    'team.chiefTypeDescription': 'בחר כיצד יש להוסיף את המנהל לארגון',
    'team.partnerSharedLeadership': 'שותף – מנהיגות משותפת',
    'team.partnerDescription': 'פועל כמנהל משותף איתך. שניכם מנהלים את אותו צוות.',
    'team.independentChief': 'מנהל עצמאי',
    'team.independentDescription': 'מנהל ברמה העליונה נפרד עם היררכיה משלו.',
    'team.sendInvitation': 'שלח הזמנה',
    'team.emailLabel': 'אימייל',
    'team.jobTitleLabel': 'תפקיד',
    'team.teamMemberSettings': 'הגדרות חבר',
    'team.manageWorkSettings': 'נהל הגדרות עבודה והקצאות מנהלים.',
    'team.workSettings': 'הגדרות עבודה',
    'team.managers': 'מנהלים',
    'team.selectWorkDaysMember': 'בחר את הימים שחבר זה עובד בדרך כלל.',
    ...
    'landing.description': 'פתרון הניהול המקיף לכל סוגי הצוותים. עקוב אחר שעות עבודה, נהל פרויקטים בצורה חכמה והובל את הארגון שלך להצלחה. פלטפורמה מקצועית וגמישה המותאמת לצרכים של כל עסק.',
