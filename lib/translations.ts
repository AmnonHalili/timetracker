...
export const translations = {
  en: {
    ...
    'tasks.subtaskDueSoon': 'Due in {days} days',
    'tasks.subtaskOverdue': 'Overdue by {days} days',
  ...
  he: {
    ...
    'tasks.usersWorking': '{count} משתמשים עובדים על זה',
    ...
    'tasks.subtaskAssignedTo': 'משוייך ל',
    'tasks.subtaskDueDate': 'מועד יעד',
    'tasks.subtaskNoPriority': 'ללא עדיפות',
    'tasks.subtaskNoAssignee': 'לא משוייך',
    'tasks.subtaskDueSoon': 'נותרו {days} ימים',
    'tasks.subtaskOverdue': 'באיחור של {days} ימים',
    'tasks.subtaskDueToday': 'מועד היום',
